...
|------|-------------|------|---------|:--------:|
| <a name="input_subscription_id"></a> [subscription\_id](#input\_subscription\_id) | The subscription ID for the deployment. | `string` | `"f25bbc73-3aa3-413f-b724-ab031e6e3a89"` | no |
